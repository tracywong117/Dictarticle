<template>
    <div class="tooltip-container" @mouseover="showTooltip">
      <slot name="reference"></slot>
      <div v-if="visible" :style="tooltipStyles" class="custom-tooltip">
  ...
  export default {
    ...
    methods: {
      ...
      openSearchTab(siteName) {
        let url = "";
        const searchText = this.$slots.default[0].text; // Assuming default slot text is the search text
        switch (siteName) {
          case "Google":
