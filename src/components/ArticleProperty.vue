<template>
    <div ref="dropdown">
        <div class="flex my-2 w-full items-start font-sans">
            <div class="relative flex items-center" @click="toggleKeyDropdown">
                    ...
                    <div v-if="valueDropdownVisible" class="p-2 w-full tag-text">
                        ...
                        <div v-else>
                            ...
                            :class="[
                                ...
                                <img src="/icons/more-horizontal.svg" alt="Show More"
                                    v-if="draggedIndex === index || (draggedIndex === null && hoveredIndex === index)"
                                    class="ml-auto w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
        ...
        <div v-if="keyDropdownVisible" class="origin-top-left absolute mt-1 rounded border bg-white 
...
export default {
    ...
    methods: {
        toggleKeyDropdown() {
            this.keyDropdownVisible = !this.keyDropdownVisible;
        ...
        handleClickOutside(event) {
            if (this.keyDropdownVisible && this.$refs.dropdown && !this.$refs.dropdown.contains(event.target)) {
                this.keyDropdownVisible = false;
                this.resetShowOption();
            }
